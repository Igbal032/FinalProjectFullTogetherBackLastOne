...
namespace FinalProjectMain.Areas.Admin.Controllers
{
    ...
    public class AdGetOnController : Controller
    {
        ...
        public ActionResult deleteItemFromSharedItem(int id)
        {
            ...
            return PartialView("~/Areas/AdGetOn/Views/Admin/sharedItemss.cshtml", products);
        }
        ...
        public ActionResult CategorySelectInCreateItem()
        {
            ...
            return PartialView("~/Areas/AdGetOn/Views/Admin/CategorySelectInCreateItem.cshtml", categories);
        }
        ...
        {
            List<SubCategory> subcategories = db.SubCategories.Where(c => c.DeletedDate == null && c.CategoryId == categoryId).ToList();
            if (subcategories.Count != 0)
            {

                return PartialView("~/Areas/AdGetOn/Views/Admin/MultiCategorySelectInCreateItem.cshtml", subcategories);
            }
        ...
        public ActionResult addNewCategory(string categoryname, int? withSubCategory)
        {
            ...
            else
            {
                ...
                db.SaveChanges();
                return PartialView("~/Areas/AdGetOn/Views/Admin/CategorySelectInCreateItem.cshtml", db.categories.Where(w => w.DeletedDate == null).ToList());
            }
        ...
        public ActionResult addNewSubCategory(int? categoryId, string subcategoryname)
        {
            ...
            else
            {
                ...
                db.SaveChanges();
                return PartialView("~/Areas/AdGetOn/Views/Admin/MultiCategorySelectInCreateItem.cshtml", db.SubCategories.Where(w => w.DeletedDate == null && w.CategoryId == categoryId).ToList());
            }
        ...
        public ActionResult addNewColor(string colorname)
        {
            ...
            else
            {
                ...
                db.SaveChanges();
                return PartialView("~/Areas/AdGetOn/Views/Admin/ColorInCreateItem.cshtml", db.Color.Where(w => w.DeletedDate == null).ToList());
            }
        ...
        public ActionResult addNewProducer(string producername)
        {
            ...
            else
            {
                ...
                db.SaveChanges();
                return PartialView("~/Areas/AdGetOn/Views/Admin/ProducerInCreateItem.cshtml", db.producers.Where(w => w.DeletedDate == null).ToList());
            }

        }
        public ActionResult ProducerInCreateItem()
        {
            var producers = db.producers.Where(p => p.DeletedDate == null).ToList();
            return PartialView("~/Areas/AdGetOn/Views/Admin/ProducerInCreateItem.cshtml", producers);
        }
        public ActionResult ColorInCreateItem()
        {
            var colors = db.Color.Where(c => c.DeletedDate == null).ToList();
            return PartialView("~/Areas/AdGetOn/Views/Admin/ColorInCreateItem.cshtml", colors);
        }
        public ActionResult userslist()
        {

            var userslist = db.user.Where(w => w.DeletedDate == null).ToList();
        ...
        public ActionResult ignoreUser(int id)
        {
            ...
            db.SaveChanges();
            var userslist = db.user.Where(w => w.DeletedDate == null).ToList();
            return PartialView("~/Areas/AdGetOn/Views/Admin/usersListForeach.cshtml", userslist);
        }
        ...
        public ActionResult employeeList()
        {
            ...
            var employeelist = db.Manager.Where(w => w.DeletedDate == null).ToList();
        ...
        public ActionResult DeleteEmployeeInList(int id)
        {
            ...
            db.SaveChanges();
            return PartialView("~/Areas/AdGetOn/Views/Admin/employeeListForeach.cshtml", db.Manager.Where(w => w.DeletedDate == null).ToList());
        }
        ...
        public ActionResult EditEmployeeInListSubmit(Manager editmanager)
        {
            ...
            db.SaveChanges();
            var employeList = db.Manager.Where(w => w.DeletedDate == null).ToList();
            return PartialView("~/Areas/AdGetOn/Views/Admin/employeeListForeach.cshtml", employeList);
        }
        ...
        public ActionResult statusInCreateAdmin()
        {
            ...
            var managerStatuses = db.ManagerStatus.Where(m => m.DeletedDate == null).ToList();
            return PartialView("~/Areas/AdGetOn/Views/Admin/statusInCreateAdmin.cshtml", managerStatuses);
        }
        ...
        public ActionResult sharedItemss()
        {
            ...
            var sharedItems = db.products.OrderByDescending(o => o.Id).Where(m => m.DeletedDate == null && m.isConfirm == true).ToList();
